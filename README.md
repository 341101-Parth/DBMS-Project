...
3. Supports complex SQL series: The structure naturally encourages joins between tables, grouping and aggregation etc. 
4. Encourages problem solving mindset: The dataset can be used to generate real questions such as "which department has the highest employees? ", " Which city has the most staff? ”, "What is the average age per department? ", " Find employees working in more than one area. " This improves analytical thinking using SQL
